...
[`storyboard.md`](../../../../content/live-showcase/docs/storyboard.md); every word it says is in [`script.md`](../../../../content/live-showcase/docs/script.md).
...
The seven rules are in [`storyboard.md`](../../../../content/live-showcase/docs/storyboard.md) and each one does work that narration would
